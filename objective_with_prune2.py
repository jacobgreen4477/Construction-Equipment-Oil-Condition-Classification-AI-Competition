def objective_with_prune2(trial:Trial):         
      
    global seed_num,drop_features,categorical_feature
    print('seed_num:',seed_num)
    print('# of drop_features:',len(drop_features))
    ...
    def fit_lgbm_with_pruning(trial:Trial, train_x, train_y, valid_x, valid_y, drop_features, categorical_feature, seed_num):
